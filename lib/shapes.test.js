...
describe('Validate', () => {
    it('should return a string for a  SVG Circle', () => {
        const shape = new Circle("Hey", "white", "Circle", "Red");
    ...
    it('should return a string for a SVG Triangle', () => {
    ...
    it('should return a string for a SVG Square', () => {
